<?php 
    ...
    class Empregado{
        ...
        public function atualizar(){
            ...
            $sql = "UPDATE empregado SET no_matricula = $this->noMatricula, nome = '$this->nome', sobrenome = '$this->sobrenome',
             data_Contratacao = '$this->dataContratacao', data_Nascimento = '$this->dataNascimento' WHERE id = $this->id"; 
